  ...
  function renderInlineImmersionControls(profile){
    ...
    return [
      '<section id="a-site-v2-inline-control" class="asv2-inline-control" aria-label="Phase 5 镜头与时间控制">',
        '<div class="asv2-inline-head"><div><b>镜头 / 时间推进</b><span>Phase 5 日常控制</span></div><button type="button" class="asv2-inline-debug" data-asv2-inline-action="advanced">V2调试</button></div>',
